...
tf.app.flags.DEFINE_string('style_image', '/Users/leidelong/data/neural_style/starry_night.jpg', 'style image')
tf.app.flags.DEFINE_string('content_image', '/Users/leidelong/data/neural_style/flower.jpg', 'content image')
#tf.app.flags.DEFINE_string('content_image', 'private.jpeg', 'content image')
...
def vgg_params():
    ...
    if _vgg_params is None:
        _vgg_params = scipy.io.loadmat('/Users/leidelong/data/model/imagenet-vgg-verydeep-19.mat')
    return _vgg_params
...
def stylize(style_image, content_image, learning_rate=0.1, epochs=500):
    ...
    with tf.Session() as sess:
        ...
        for i in range(epochs):
            ...
            if (i + 1) % 10 == 0:
                # save target image every 10 iterations
                image = np.clip(target_image + 128.0, 0, 255).astype(np.uint8)
                Image.fromarray(image).save("/Users/leidelong/data/neural_style/out/neural_%d.jpg" % (i + 1))
