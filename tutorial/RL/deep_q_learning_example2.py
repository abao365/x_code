...
@time: 2017/2/18 下午8:32
@source:http://blog.csdn.net/supercally/article/details/54784103
"""
...
class DQN():
    def __init__(self, env):
        ...
        self.summary_writer = tf.train.SummaryWriter('/tmp/to/logs', self.session.graph)
